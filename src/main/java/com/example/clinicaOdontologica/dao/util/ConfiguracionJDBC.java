...
public class ConfiguracionJDBC {
   ...
   public static Logger logger = Logger.getLogger(ConfiguracionJDBC.class);
    ...
    public void ConfiguracionJDBC(String jdbcDriver, String dbUrl, String nombreUsuario, String contrasenaUsuario) {
    ...
    public ConfiguracionJDBC() {
        ...
        this.dbUrl = "jdbc:h2:~/db_test;INIT=RUNSCRIPT FROM 'script.sql'";
